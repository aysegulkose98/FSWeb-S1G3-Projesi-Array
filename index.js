...
// console.log("satır  107" , sonCesitiKaldir(orijinalTatlar));
...
function ismeGoreCesitCikar(dizi, eskitat){
...
function ismeGoreFiltrele(tatlar,filtredeger ){
  let yenidizi = []; 
  
  for(let i=0; i<tatlar.length; i++){
    if(tatlar[i].includes(filtredeger)){
